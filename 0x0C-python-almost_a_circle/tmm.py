...
class TestRectangle_x(unittest.TestCase):
    ...
    def test_str_x(self):
        with self.assertRaisesRegectangle(1, 2, {1, 2, 3}, 2)
...
class TestRectangle_to_dictionary(unittest.TestCase):
    ...
    def test_to_dictionary_arg(self):
        ...
        with self.assertRaises(TypeError):
            r.to_dictionary(1)elf.assertRaisesRegex(TypeError, "width must be an integer"):
    ...
    def test_nan_width(sx(TypeError, "x must be an integer"):
    ...
    def test_set_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Re Rectangle(1, 2, 3, frozenset({1, 2, 3, 1}))
...
class TestRectangle_height(unittest.TestCase):
    ...
    def test_None_height(self):
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
x(TypeError, "x must be an integer"):
